...
# install.sh перезаписывает этот файл во время выполнения.
# Чтобы избежать "command not found" ошибок из-за изменения файла на диске,
# копируем себя во временный файл и запускаемся оттуда.
# ═══════════════════════════════════════════════════════════════════════════════
